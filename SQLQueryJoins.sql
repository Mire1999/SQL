...
select f.Id,f.[Name],CONCAT_WS(' ',CONCAT_WS(' ',a.line1,a.line2,a.line3,a.POBox),
	CASE
	WHEN a.line1 is not null or a.line2 is not null or a.line3 is not null or a.POBox is not null 
	then CONCAT (',',c.[name])
	else c.[name]
	end)
	 as [Address]
